...
PREFIX_INCLUDE=/cvmfs/cms.cern.ch/slc7_amd64_gcc900/external/pythia8/303-ljfedo3/include
PREFIX_LIB=/cvmfs/cms.cern.ch/slc7_amd64_gcc900/external/pythia8/303-ljfedo3/lib
...
main%: $(PYTHIA) main%.cc
	$(CXX) $@.cc -o $@ $(CXX_COMMON) `$(ROOT_CONFIG) --cflags --glibs`
