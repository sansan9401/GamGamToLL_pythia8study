...
int main() {
  ...
  Hist etaHist("lepton eta", 40, -20, 20);
  Hist ptHist("lepton pt", 20, 0, 50);
  ...
  for (int iEvent = 0; iEvent < nEvent; ++iEvent) {
    ...
    etaHist.fill(p1.eta(), weight);
    etaHist.fill(p2.eta(), weight);
    ptHist.fill(p1.pT(), weight);
    ptHist.fill(p2.pT(), weight);
